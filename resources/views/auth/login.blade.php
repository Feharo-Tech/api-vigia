    ...
    <div class="max-w-md w-full mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <div class="flex justify-center mb-8">
            <div class="flex items-center">
                ...
                <span class="ml-2 text-2xl font-semibold text-gray-800 dark:text-white">API Vigia InMediam</span>
            </div>
        </div>

        <!-- Session Status -->
        <x-auth-session-status
            class="mb-4 p-4 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-md"
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    @if (Route::has('password.request'))
                        <a class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300"
            ...
            <div>
                <x-primary-button
                    class="w-full justify-center py-2.5 bg-blue-600 hover:bg-blue-700 focus:ring-blue-500">
