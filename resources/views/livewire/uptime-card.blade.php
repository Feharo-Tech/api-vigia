    ...
    <div class="p-6">
        <div class="flex justify-between items-start">
            <h2 class="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                ...
                Uptime das APIs <small class="ml-2">(30 dias)</small>
            </h2>
        </div>
            ...
            @forelse ($uptimeData as $api)
                <div class="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-semibold {{ $api['uptime'] >= 99 ? 'text-green-600' : ($api['uptime'] >= 95 ? 'text-yellow-600' : 'text-red-600') }}">
                            {{ $api['uptime'] }}%
                        </span>
                    </div>
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div 
                            class="h-2 rounded-full {{ $api['uptime'] >= 99 ? 'bg-green-500' : ($api['uptime'] >= 95 ? 'bg-yellow-500' : 'bg-red-500') }}" 
